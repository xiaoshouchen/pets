package com.pets.common.activity.videopreview;
...
import com.pets.videoupload.TXUGCPublish;
import com.pets.videoupload.TXUGCPublishTypeDef;
...
//        Intent intent = new Intent(this, TCVideoEditerActivity.class);
        ...
        try {
            editActivityClass = Class.forName("com.pets.shortvideo.editor.TCVideoPreprocessActivity");
